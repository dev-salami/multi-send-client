export const EVENT_TICKET_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "_ticketName", type: "string", internalType: "string" },
      { name: "_ticketCode", type: "string", internalType: "string" },
      { name: "_maxTicket", type: "uint256", internalType: "uint256" },
      { name: "_publicTicketPrice", type: "uint256", internalType: "uint256" },
      { name: "_vipTicketPrice", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
...
export const EVENT_FACTORY_ABI = [
  ...
  },
  {
    ...
    outputs: [
      { name: "", type: "address", internalType: "contract TicketNFT" },
    ],
    stateMutability: "view",
  },
  {
